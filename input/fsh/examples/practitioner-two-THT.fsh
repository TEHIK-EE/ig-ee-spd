...
* qualification[speciality][=].period.start = "1999-08-09"
...
* qualification[proffession][=].period.start = "1999-05-21"
* qualification[proffession][=].extension[THTcode].url = "https://fhir.ee/spd/StructureDefinition/ee-tis-tht-code"
* qualification[proffession][=].extension[THTcode].valueString = "N99876"
...
* qualification[proffession][=].period.start = "1992-05-21"
* qualification[proffession][=].extension[THTcode].url = "https://fhir.ee/spd/StructureDefinition/ee-tis-tht-code"
* qualification[proffession][=].extension[THTcode].valueString = "M99876"
