...
* identifier[=].period.start = "2012-01-12"
/* qualification[specialty].code.coding[0].system = "https://fhir.ee/ValueSet/erialad" 
* qualification[specialty].code.coding[0].code = #N100
* qualification[specialty].code.coding[0].display = "Intensiivõendus"
* qualification[specialty].code.coding[+].system = "https://fhir.ee/ValueSet/erialad" 
* qualification[specialty].code.coding[+].code = #N300
* qualification[specialty].code.coding[+].display = "Terviseõendus"
