...
* managingOrganization = Reference(Organization/OrganizationPERH)
* address
  * use = #work
...
* address.extension[0].valueCodeableConcept.coding[0].system = "urn:ietf:rfc:3986" // või muu asjakohane system
* address.extension[0].valueCodeableConcept.text = "2107287"
