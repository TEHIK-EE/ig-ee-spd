...
* code[role].coding.system = "https://fhir.ee/CodeSystem/autoriseerimismooduli-kasutajarollid"
...
* code[tor].coding.system = "https://fhir.ee/CodeSystem/ametite-klassifikaator"
