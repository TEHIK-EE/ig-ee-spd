...
* qualification[speciality].code.coding from https://fhir.ee/ValueSet/erialad
...
* qualification[kutse].code.coding from https://fhir.ee/ValueSet/tervishoiutootaja-kutse
